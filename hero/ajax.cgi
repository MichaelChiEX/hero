...
if($ext_tmpxs>0){
    ...
    if ($mtotal > 100 && $mtotal%100 eq "1"){$dun="$SEN[20],20<>$dun";}
    if ($mtotal > 100 && $mtotal%300 eq "2"){$dun="$SEN[21],21<>$dun";}
    if ($mtotal > 100 && $mtotal%600 eq "3"){$dun="$SEN[22],22<>$dun";}
    if ($mtotal > 100 && $mtotal%3000 eq "4"){$dun="$SEN[23],23<>$dun";}
    if ($mtotal > 100 && $mtotal%10000 eq "5"){$dun="$SEN[24],24<>$dun";}

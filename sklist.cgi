...
foreach(@ABILITY){
	...
	@clname = ();
	foreach $job_id (@jlist){
		push(@clname, $JOB[$job_id])
	}
	$clname = join("、", @clname);
	if ($clname eq "") {
	...
	$stable.="
		<tr bgColor=#FFFFFF>
			<td><font color=\"#0000ff\">$abname</font></td>
			<td><font color=\"#008000\">$abcom</font></td>
			<td align=right><font color=AA3333>$abpoint</font></td>
			<td><font color=AA3333>$clname</font></td>
		</tr>";
}
print <<"EOF";
<p align="center">
...
<table id="table1" cellSpacing="0" cellPadding="0" border="1" width="600">
	<tr>
		...
		<td bgColor="#ccffcc" width="150"><b>可習得職業</b></td>
	</tr>
	$stable
</table>
